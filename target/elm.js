...
var _user$project$Main$toWeekDay = function (unparsed) {
	var _p0 = _elm_lang$core$Date$fromString(unparsed);
	if (_p0.ctor === 'Ok') {
		var _p1 = _elm_lang$core$Date$dayOfWeek(_p0._0);
		switch (_p1.ctor) {
			case 'Mon':
				return 'Måndag';
			case 'Tue':
		...
		return 'Inget bra datum';
	}
};
var _user$project$Main$viewDay = function (meal) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[_debois$elm_mdl$Material_Typography$center, _debois$elm_mdl$Material_Typography$subhead]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$Main$toWeekDay(meal.date))
					])),
				A3(
				_debois$elm_mdl$Material_Options$styled,
				_elm_lang$html$Html$p,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_debois$elm_mdl$Material_Options$css, 'width', '480px')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_debois$elm_mdl$Material_Options$css, 'background', 'url(\'http://rustlersonline.com/wp-content/uploads/HotDog.png\') center / cover'),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_debois$elm_mdl$Material_Options$css, 'padding', '16px 0px 16px 0px'),
								A2(_debois$elm_mdl$Material_Options$css, 'width', '100%'),
								A2(_debois$elm_mdl$Material_Options$css, 'font-size', '200%'),
								_debois$elm_mdl$Material_Options$center
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Matsedel')
							]))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$List$map, _user$project$Main$viewDay, model.meals))
					]))
			]));
};
var _user$project$Main$decodeCourses = _elm_lang$core$Json_Decode$list(
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string));
var _user$project$Main$Meal = F2(
	function (a, b) {
		return {date: a, courses: b};
	});
var _user$project$Main$decodeDays = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Main$Meal,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'date', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'courses', _user$project$Main$decodeCourses));
var _user$project$Main$decodeMeals = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['meals']),
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeDays));
var _user$project$Main$decodeData = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data']),
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeMeals));
var _user$project$Main$Model = F2(
	function (a, b) {
		return {meals: a, mdl: b};
	});
var _user$project$Main$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$minute, _user$project$Main$Tick);
};
...
var _user$project$Main$getMeals = function () {
	var url = 'https://skolmaten.se/api/openmeal/v2/meals.json?distributorID=5323089923538944';
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$FetchFail,
		_user$project$Main$FetchSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Main$decodeData, url));
}();
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		meals: _elm_lang$core$Native_List.fromArray(
			[
				{
				date: 'idag',
				courses: _elm_lang$core$Native_List.fromArray(
					['mat', 'kött'])
			}
			]),
		mdl: _debois$elm_mdl$Material$model
	},
	_1: _user$project$Main$getMeals
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'Tick':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getMeals};
			case 'Mdl':
			...
			default:
				var l = A2(
					...
					_elm_lang$core$List$head(_p2._0));
				var p = {mdl: model.mdl, meals: l};
				return {ctor: '_Tuple2', _0: p, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
